...
const FR: Dict = {
  ...
  'details.status.offline': "Disponible hors ligne",
  'details.status.partial': "Partiellement disponible hors ligne",
  'details.status.online': "Sur Google Drive uniquement",
  'details.status.syncing': "Synchronisation en cours…",
  'details.count': "{synced} fichier(s) sur {total} disponible(s) hors ligne",
  'details.countLoading': "{synced} fichier(s) disponible(s) hors ligne",
...
const EN: Dict = {
  ...
  'details.status.offline': "Available offline",
  'details.status.partial': "Partly available offline",
  'details.status.online': "On Google Drive only",
  'details.status.syncing': "Syncing…",
  'details.count': "{synced} of {total} file(s) available offline",
  'details.countLoading': "{synced} file(s) available offline",
