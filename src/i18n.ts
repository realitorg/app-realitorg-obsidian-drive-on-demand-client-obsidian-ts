...
const FR: Dict = {
  ...
  'details.open': "Détails de synchronisation",
  'details.status.syncing': "Synchronisation en cours…",
  'details.progress': "{done} sur {total}",
  'details.failed': "{count} fichier(s) n'ont pas pu être synchronisé(s) :",
  'details.failedMore': "et {count} autre(s)",
  'details.makeOffline': "Rendre disponible hors ligne",
  'details.retry': "Réessayer",
  'details.freeUp': "Libérer l'espace local",
  'details.freeUpHint': "Retire la copie de cet appareil. Tout reste sur le drive.",
  'details.makeOfflineHint': "Sur le drive uniquement. Hors ligne, vous pourrez l'ouvrir et le modifier sans connexion.",
  'details.partialHint': "Une partie seulement est sur cet appareil.",
  'details.status.local': "Sur cet appareil uniquement",
  'details.upload': "Envoyer sur le drive",
  'details.localHint': "Sur cet appareil uniquement, pas encore sur le drive.",
  'details.localParentHint': "Sur cet appareil uniquement. Envoyez le dossier parent pour l'envoyer avec.",
  'details.status.offline': "Synchronisé",
  'details.status.partial': "Partiellement synchronisé",
  'details.status.online': "Non synchronisé",
  'details.cancel': "Annuler",
  'details.openInDrive': "Ouvrir dans le drive",
  'delete.confirmDrive': "{count} éléments synchronisés ont été supprimés du vault. Les mettre aussi dans la corbeille du drive ? Sinon, ils restent sur le drive.",
  'delete.confirmLocal': "{count} éléments synchronisés ont été supprimés du drive. Les mettre aussi dans la corbeille du vault (.trash) ? Sinon, ils restent dans le vault.",
  'delete.confirmButton': "Supprimer aussi",
  'delete.driveError': "« {path} » n'a pas pu être mis dans la corbeille Drive : {error}",
  'settings.accountName': "Compte",
  ...
  'settings.connectStarted': "Ouverture de la connexion dans le navigateur…",
  'settings.connectedOk': "Compte connecté.",
  ...
  'main.authCancelled': "Connexion annulée : {error}",
...
const EN: Dict = {
  ...
  'details.open': "Sync details",
  'details.status.syncing': "Syncing…",
  'details.progress': "{done} of {total}",
  'details.failed': "{count} file(s) could not be synced:",
  'details.failedMore': "and {count} more",
  'details.makeOffline': "Make available offline",
  'details.retry': "Retry",
  'details.freeUp': "Free up local space",
  'details.freeUpHint': "Removes the copy on this device. Everything stays on the drive.",
  'details.makeOfflineHint': "On the drive only. Offline, you can open and edit it without a connection.",
  'details.partialHint': "Only part of it is on this device.",
  'details.status.local': "On this device only",
  'details.upload': "Upload to the drive",
  'details.localHint': "On this device only, not on the drive yet.",
  'details.localParentHint': "On this device only. Upload the parent folder to include it.",
  'details.status.offline': "Synced",
  'details.status.partial': "Partly synced",
  'details.status.online': "Not synced",
  'details.cancel': "Cancel",
  'details.openInDrive': "Open in the drive",
  'delete.confirmDrive': "{count} synced items were deleted from the vault. Move them to the drive trash too? Otherwise they stay on the drive.",
  'delete.confirmLocal': "{count} synced items were deleted from the drive. Move them to the vault trash (.trash) too? Otherwise they stay in the vault.",
  'delete.confirmButton': "Delete too",
  'delete.driveError': "Could not move “{path}” to the Drive trash: {error}",
  ...
  'settings.connectStarted': "Opening sign-in in your browser…",
  'settings.connectedOk': "Account connected.",
  ...
  'main.authCancelled': "Connection cancelled: {error}",
