...
const FR: Dict = {
  ...
  'settings.vaultSettingsName': "Synchroniser les réglages du vault",
  'settings.vaultSettingsDesc': "Synchronise le dossier .obsidian (apparence, raccourcis, plugins installés et LEURS réglages) entre vos appareils. Exclus : ce plugin (votre jeton reste local) et la disposition des panneaux, propre à chaque appareil. Attention : les réglages des autres plugins peuvent contenir des clés d'API — ils seront copiés sur votre Drive. Les réglages tirés s'appliquent au redémarrage d'Obsidian.",
  'settings.vaultSettingsOn': "Réglages du vault synchronisés — redémarrez Obsidian pour les appliquer.",
...
const EN: Dict = {
  ...
  'settings.vaultSettingsName': "Sync vault settings",
  'settings.vaultSettingsDesc': "Syncs the .obsidian folder (appearance, hotkeys, installed plugins and THEIR settings) across your devices. Excluded: this plugin (your token stays local) and pane layout, which is device-specific. Warning: other plugins' settings may contain API keys — they will be copied to your Drive. Pulled settings apply after restarting Obsidian.",
  'settings.vaultSettingsOn': "Vault settings synced — restart Obsidian to apply them.",
