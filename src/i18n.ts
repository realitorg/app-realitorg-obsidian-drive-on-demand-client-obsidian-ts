...
const FR: Dict = {
  ...
  'details.freeUpHint': "Libérer l'espace retire seulement la copie de cet appareil : tout reste sur Google Drive.",
  'details.makeOfflineHint': "Pour l'instant sur Google Drive uniquement. Rendez-le disponible hors ligne pour l'ouvrir et le modifier sans connexion ; vos modifications seront renvoyées sur Drive.",
  ...
  'details.openInDrive': "Ouvrir dans Google Drive",
  'delete.confirmDrive': "{count} éléments synchronisés ont été supprimés du vault. Les mettre aussi dans la corbeille Google Drive ? Sinon, ils restent sur Drive.",
  'delete.confirmLocal': "{count} éléments synchronisés ont été supprimés de Google Drive. Les mettre aussi dans la corbeille du vault (.trash) ? Sinon, ils restent dans le vault.",
...
const EN: Dict = {
  ...
  'details.freeUpHint': "Freeing up space only removes the copy on this device: everything stays on Google Drive.",
  'details.makeOfflineHint': "Currently on Google Drive only. Make it available offline to open and edit it without a connection; your changes are sent back to Drive.",
  ...
  'details.openInDrive': "Open in Google Drive",
  'delete.confirmDrive': "{count} synced items were deleted from the vault. Move them to the Google Drive trash too? Otherwise they stay on Drive.",
  'delete.confirmLocal': "{count} synced items were deleted from Google Drive. Move them to the vault trash (.trash) too? Otherwise they stay in the vault.",
