...
const FR: Dict = {
  ...
  'details.freeUpHint': "Libérer l'espace retire seulement la copie de cet appareil : tout reste sur le drive.",
  'details.makeOfflineHint': "Pour l'instant sur le drive uniquement. Rendez-le disponible hors ligne pour l'ouvrir et le modifier sans connexion ; vos modifications seront renvoyées sur le drive.",
  'details.partialHint': "Une partie seulement du contenu est sur cet appareil. Rendez tout le dossier disponible hors ligne pour l'avoir en entier sans connexion.",
...
const EN: Dict = {
  ...
  'details.freeUpHint': "Freeing up space only removes the copy on this device: everything stays on the drive.",
  'details.makeOfflineHint': "Currently on the drive only. Make it available offline to open and edit it without a connection; your changes are sent back to the drive.",
  'details.partialHint': "Only part of the content is on this device. Make the whole folder available offline to have all of it without a connection.",
