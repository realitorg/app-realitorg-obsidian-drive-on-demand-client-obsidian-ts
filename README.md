...
- **Selective sync** — a small status mark per file and folder (synced, partly synced, not synced). Only what you choose is materialised in your vault. Long-press (mobile) or right-click (desktop) a row to sync it or see its details: progress, partly synced folders, failed files, free up local space, open in Google Drive.
